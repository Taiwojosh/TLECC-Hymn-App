...
// Updated to a Latin Cross for Church Doctrine
export const CrossIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20" /><path d="M7 8h10" /></svg>
);
...
export const DonateIcon = (props: React.SVGProps<SVGSVGElement>) => (
    <svg {...props} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M7 10v12" /><path d="M15 5.88 14 10h4.83a2 2 0 0 1 1.94 2.53l-2.72 9.51A2 2 0 0 1 16.17 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.72a2 2 0 0 0 1.94-1.45L8 3.54A2 2 0 0 1 9.88 2h.24a2 2 0 0 1 1.94 1.45l.6 2.1Z" /></svg>
);
